...
[
    ...
    'auto_translation_service' => [
        [
            ...
            'api_url' => null // if you use your own custom translation provider, add here a custom GET api endpoint (example: https://tld.com/api/?str=%str%&from=%lng_source%&to=%lng_target%)
        ]
    ],
