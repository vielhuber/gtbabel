...
use ScopedGtbabel\Dotenv\Store\File\Paths;
class StoreBuilder
{
    /**
    ...
    {
        return new self($this->paths, $this->names, \true);
    }
    /**
    ...
    {
        return new \ScopedGtbabel\Dotenv\Store\FileStore(\ScopedGtbabel\Dotenv\Store\File\Paths::filePaths($this->paths, $this->names === null ? ['.env'] : $this->names), $this->shortCircuit);
    }
}
