...
use ScopedGtbabel\Dotenv\Repository\Adapter\ArrayAdapter;
use InvalidArgumentException;
abstract class AbstractRepository implements \ScopedGtbabel\Dotenv\Repository\RepositoryInterface
{
    /**
     * Are we immutable?
     *
    ...
    public function __construct($immutable)
    {
        ...
        $this->loaded = new \ScopedGtbabel\Dotenv\Repository\Adapter\ArrayAdapter();
    }
    /**
