...
namespace ScopedGtbabel\Dotenv\Repository;

use ScopedGtbabel\Dotenv\Repository\Adapter\ApacheAdapter;
use ScopedGtbabel\Dotenv\Repository\Adapter\AvailabilityInterface;
use ScopedGtbabel\Dotenv\Repository\Adapter\EnvConstAdapter;
use ScopedGtbabel\Dotenv\Repository\Adapter\PutenvAdapter;
use ScopedGtbabel\Dotenv\Repository\Adapter\ServerConstAdapter;
class RepositoryBuilder
{
    ...
    public function make()
    {
        ...
        return new \ScopedGtbabel\Dotenv\Repository\AdapterRepository($this->readers === null ? $defaults : $this->readers, $this->writers === null ? $defaults : $this->writers, $this->immutable);
    }
    /**
    ...
    {
        return self::filterByAvailability([new \ScopedGtbabel\Dotenv\Repository\Adapter\ApacheAdapter(), new \ScopedGtbabel\Dotenv\Repository\Adapter\EnvConstAdapter(), new \ScopedGtbabel\Dotenv\Repository\Adapter\ServerConstAdapter(), new \ScopedGtbabel\Dotenv\Repository\Adapter\PutenvAdapter()]);
    }
    /**
    ...
    {
        return \array_filter($adapters, function (\ScopedGtbabel\Dotenv\Repository\Adapter\AvailabilityInterface $adapter) {
