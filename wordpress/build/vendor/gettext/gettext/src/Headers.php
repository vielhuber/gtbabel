...
class Headers implements \JsonSerializable, \Countable, \IteratorAggregate
{
    ...
    protected $headers = [];
    public static function __set_state(array $state) : \ScopedGtbabel\Gettext\Headers
    {
    ...
    public function mergeWith(\ScopedGtbabel\Gettext\Headers $headers) : \ScopedGtbabel\Gettext\Headers
    {
        $merged = clone $this;
