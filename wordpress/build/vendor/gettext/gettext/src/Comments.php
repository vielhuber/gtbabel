...
{
    protected $comments = [];
    public static function __set_state(array $state) : \ScopedGtbabel\Gettext\Comments
    {
    ...
    public function mergeWith(\ScopedGtbabel\Gettext\Comments $comments) : \ScopedGtbabel\Gettext\Comments
    {
        $merged = clone $this;
