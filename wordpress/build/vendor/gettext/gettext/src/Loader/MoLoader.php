 ...
 */
final class MoLoader extends \ScopedGtbabel\Gettext\Loader\Loader
{
    private $string;
    private $position;
    private $length;
    ...
    public function loadString(string $string, \ScopedGtbabel\Gettext\Translations $translations = null) : \ScopedGtbabel\Gettext\Translations
    {
        ...
        $total = $this->readInt($byteOrder);
        //total string count
        $originals = $this->readInt($byteOrder);
        //offset of original table
        $tran = $this->readInt($byteOrder);
