...
{
    protected $flags = [];
    public static function __set_state(array $state) : \ScopedGtbabel\Gettext\Flags
    {
    ...
    {
        return \in_array($flag, $this->flags, \true);
    }
    ...
    public function mergeWith(\ScopedGtbabel\Gettext\Flags $flags) : \ScopedGtbabel\Gettext\Flags
    {
        $merged = clone $this;
