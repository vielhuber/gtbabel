...
class References implements \JsonSerializable, \Countable, \IteratorAggregate
{
    ...
    public static function __set_state(array $state) : \ScopedGtbabel\Gettext\References
    {
    ...
    public function mergeWith(\ScopedGtbabel\Gettext\References $references) : \ScopedGtbabel\Gettext\References
    {
        $merged = clone $this;
