...
namespace ScopedGtbabel\Gettext\Languages;
...
class Language
{
    ...
    private function __construct($info)
    {
        ...
        foreach ($info['categories'] as $cldrCategoryId => $cldrFormulaAndExamples) {
            $category = new \ScopedGtbabel\Gettext\Languages\Category($cldrCategoryId, $cldrFormulaAndExamples);
        ...
        \usort($this->categories, function (\ScopedGtbabel\Gettext\Languages\Category $category1, \ScopedGtbabel\Gettext\Languages\Category $category2) {
            return \array_search($category1->id, \ScopedGtbabel\Gettext\Languages\CldrData::$categories) - \array_search($category2->id, \ScopedGtbabel\Gettext\Languages\CldrData::$categories);
        });
        // The 'other' category should always be there
        if ($this->categories[\count($this->categories) - 1]->id !== \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY) {
            throw new \Exception("The language '{$info['id']}' does not have the '" . \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY . "' plural category");
        }
    ...
    {
        $result = array();
        foreach (\array_keys(\ScopedGtbabel\Gettext\Languages\CldrData::getLanguageNames()) as $cldrLanguageId) {
            $result[] = new self(\ScopedGtbabel\Gettext\Languages\CldrData::getLanguageInfo($cldrLanguageId));
        }
        return $result;
    }
    /**
    ...
    {
        $result = null;
        $info = \ScopedGtbabel\Gettext\Languages\CldrData::getLanguageInfo($id);
        if (isset($info)) {
    ...
    private function checkAlwaysTrueCategories()
    {
        ...
        if (isset($alwaysTrueCategory)) {
            ...
            $alwaysTrueCategory->id = \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY;
    ...
    private function checkAllCategoriesWithExamples()
    {
        ...
        switch (\implode(',', $badCategoriesIds) . '@' . \implode(',', $allCategoriesIds)) {
            case \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY . '@one,few,many,' . \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY:
        ...
        if ($badCategories[\count($badCategories) - 1]->id === \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY) {
            ...
            $lastGood->id = \ScopedGtbabel\Gettext\Languages\CldrData::OTHER_CATEGORY;
    ...
    private static function asciifier(&$value)
    {
        if (\is_string($value) && $value !== '') {
            ...
            $transliterated = \strtr($value, array('À' => 'A', 'Á' => 'A', 'Â' => 'A', 'Ã' => 'A', 'Ä' => 'A', 'È' => 'E', 'É' => 'E', 'Ê' => 'E', 'Ë' => 'E', 'Ì' => 'I', 'Í' => 'I', 'Î' => 'I', 'Ï' => 'I', 'Ñ' => 'N', 'Ò' => 'O', 'Ó' => 'O', 'Ô' => 'O', 'Õ' => 'O', 'Ö' => 'O', 'Ù' => 'U', 'Ú' => 'U', 'Û' => 'U', 'Ü' => 'U', 'Ÿ' => 'Y', 'Ý' => 'Y', 'à' => 'a', 'á' => 'a', 'â' => 'a', 'ã' => 'a', 'ä' => 'a', 'è' => 'e', 'é' => 'e', 'ê' => 'e', 'ë' => 'e', 'ì' => 'i', 'í' => 'i', 'î' => 'i', 'ï' => 'i', 'ñ' => 'n', 'ò' => 'o', 'ó' => 'o', 'ô' => 'o', 'õ' => 'o', 'ö' => 'o', 'ù' => 'u', 'ú' => 'u', 'û' => 'u', 'ü' => 'u', 'ý' => 'y', 'ÿ' => 'y'));
