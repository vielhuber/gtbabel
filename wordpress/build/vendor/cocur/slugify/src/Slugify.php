 ...
 */
namespace ScopedGtbabel\Cocur\Slugify;
 ...
 */
class Slugify implements \ScopedGtbabel\Cocur\Slugify\SlugifyInterface
{
     ...
     */
    protected $options = ['regexp' => self::LOWERCASE_NUMBERS_DASHES, 'separator' => '-', 'lowercase' => \true, 'lowercase_after_regexp' => \false, 'trim' => \true, 'strip_tags' => \false, 'rulesets' => [
        'default',
     ...
     */
    public function __construct(array $options = [], \ScopedGtbabel\Cocur\Slugify\RuleProvider\RuleProviderInterface $provider = null)
    {
        $this->options = \array_merge($this->options, $options);
        $this->provider = $provider ? $provider : new \ScopedGtbabel\Cocur\Slugify\RuleProvider\DefaultRuleProvider();
    ...
    public function slugify($string, $options = null)
    {
        ...
        return $options['trim'] ? \trim($string, $options['separator']) : $string;
    }
    /**
