 ...
 */
namespace ScopedGtbabel\PhpOption;
...
abstract class Option implements \IteratorAggregate
{
    ...
    public static function fromValue($value, $noneValue = null)
    {
        ...
        return new \ScopedGtbabel\PhpOption\Some($value);
    }
    /**
    ...
    public static function fromArraysValue($array, $key)
    {
        ...
        return new \ScopedGtbabel\PhpOption\Some($array[$key]);
    }
    /**
    ...
    {
        return new \ScopedGtbabel\PhpOption\LazyOption(function () use($callback, $arguments, $noneValue) {
            /** @var mixed */
            $return = \call_user_func_array($callback, $arguments);
            if ($return === $noneValue) {
                return \ScopedGtbabel\PhpOption\None::create();
            }
            return new \ScopedGtbabel\PhpOption\Some($return);
        });
    }
    /**
    ...
    public static function ensure($value, $noneValue = null)
    {
        if ($value instanceof self) {
            ...
            return new \ScopedGtbabel\PhpOption\LazyOption(function () use($value, $noneValue) {
                /** @var mixed */
                $return = $value();
