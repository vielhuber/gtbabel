 ...
 * @extends Option<T>
 */
final class LazyOption extends \ScopedGtbabel\PhpOption\Option
{
    ...
    public function orElse(\ScopedGtbabel\PhpOption\Option $else)
    {
    ...
    private function option()
    {
        if (null === $this->option) {
            ...
            if (!$this->option instanceof \ScopedGtbabel\PhpOption\Option) {
                $this->option = null;
                throw new \RuntimeException(\sprintf('Expected instance of \\%s', \ScopedGtbabel\PhpOption\Option::class));
            }
        }
        return $this->option;
    }
