...
class Test extends \ScopedGtbabel\PHPUnit\Framework\TestCase
{
    public static function setUpBeforeClass() : void
    {
        if (\file_exists(__DIR__ . '/../.env')) {
            $dotenv = \ScopedGtbabel\Dotenv\Dotenv::createImmutable(__DIR__ . '/../');
            $dotenv->load();
        }
    }
    function test__x()
    ...
    {
        $this->assertSame(\ScopedGtbabel\Person::find(1)->getAddress()->getCountry()->getName(), 'Germany');
        $this->assertEquals(\ScopedGtbabel\Person::find(2)->getAddress()->getCountry()->getName(), '');
        $this->assertEquals(\ScopedGtbabel\Person::find(3)->getAddress()->getCountry()->getName(), '');
        $this->assertTrue(\__x(\ScopedGtbabel\Person::find(1)->getAddress()->getCountry()->getName()));
        $this->assertFalse(\__x(\ScopedGtbabel\Person::find(2)->getAddress()->getCountry()->getName()));
        $this->assertSame(\__v(\ScopedGtbabel\Person::find(1)->getAddress()->getCountry()->getName(), 'default'), 'Germany');
        $this->assertSame(\__v(\ScopedGtbabel\Person::find(2)->getAddress()->getCountry()->getName(), 'default'), 'default');
    }
    function test__cookies()
    {
        ...
        $this->assertSame(\__cookie_exists('cookie_name'), \true);
        ...
        $this->assertSame(\__cookie_exists('cookie_name'), \true);
        $this->assertSame(\__cookie_get('cookie_name'), 'cookie_value');
        @\__cookie_set('special_cookie_name', 'cookie_value', 7, ['path' => '/', 'domain' => '', 'samesite' => 'None', 'secure' => \true, 'httponly' => \false]);
        $this->assertSame(\__cookie_get('special_cookie_name'), 'cookie_value');
    }
    function test__translate()
    {
        $this->assertSame(\__translate_google('Das ist das <span>Haus</span> vom Nikolaus', 'de', 'en', \getenv('GOOGLE_TRANSLATION_API_KEY')), 'This is the <span>house</span> of Santa Claus');
        $this->assertSame(\__translate_google('Das ist das <span class="notranslate">Haus</span> vom Nikolaus', 'de', 'en', \getenv('GOOGLE_TRANSLATION_API_KEY')), 'This is the <span class="notranslate">Haus</span> of Santa Claus');
        $this->assertSame(\__translate_google('Telefon: <a>+49 (0) 89 21 540 01 42</a><br/> Telefax: +49 (0) 89 21 544 59 1<br/> E-Mail: <a>david@vielhuber.local.vielhuber.de</a>', 'de', 'en', \getenv('GOOGLE_TRANSLATION_API_KEY')), 'Telephone: <a>+49 (0) 89 21 540 01 42</a> <br/> Fax: +49 (0) 89 21 544 59 1 <br/> Email: <a>david@vielhuber.local.vielhuber.de</a>');
        $this->assertSame(\__translate_google('Sein oder Nichtsein; das ist hier die Frage.', 'de', 'en', \getenv('GOOGLE_TRANSLATION_API_KEY')), 'To be or not to be; that is the question.');
        $this->assertSame(\__translate_google('Sein oder Nichtsein; das ist hier die Frage.', 'de', 'en', 'WRONG_KEY!'), null);
        $this->assertSame(\__translate_google('<a>VanillaJS</a> ist seit <a>ES6</a> quasi in allen Bereichen dem Urgestein <a>jQuery</a> ebenbürtig und inzwischen weit überlegen.', 'de', 'en', \getenv('GOOGLE_TRANSLATION_API_KEY')), '<a>VanillaJS</a> has been on <a>par with</a> the veteran <a>jQuery</a> in almost all areas since <a>ES6</a> and is now far superior.');
        $this->assertSame(\__translate_google('<a p="1">VanillaJS</a> ist seit <a p="2">ES6</a> quasi in allen Bereichen dem Urgestein <a p="3">jQuery</a> ebenbürtig und inzwischen weit überlegen.', 'de', 'en', \getenv('GOOGLE_TRANSLATION_API_KEY')), '<a p="1">VanillaJS</a> has been on <a p="1">par with</a> the veteran <a p="3">jQuery</a> in almost all areas since <a p="2">ES6</a> and is now far superior.');
        $this->assertSame(\__translate_microsoft('Sein oder Nichtsein; das ist hier die Frage.', 'de', 'en', \getenv('MICROSOFT_TRANSLATION_API_KEY')), 'Being or not being; that is the question here.');
        $this->assertSame(\__translate_microsoft('<a>VanillaJS</a> ist seit <a>ES6</a> quasi in allen Bereichen dem Urgestein <a>jQuery</a> ebenbürtig und inzwischen weit überlegen.', 'de', 'en', \getenv('MICROSOFT_TRANSLATION_API_KEY')), 'Since <a>ES6,</a> <a>VanillaJS</a> has been on an equal footing with the original rock <a>jQuery</a> in virtually all areas and is now far superior.');
        $this->assertSame(\__translate_microsoft('<a p="1">VanillaJS</a> ist seit <a p="2">ES6</a> quasi in allen Bereichen dem Urgestein <a p="3">jQuery</a> ebenbürtig und inzwischen weit überlegen.', 'de', 'en', \getenv('MICROSOFT_TRANSLATION_API_KEY')), 'Since <a p="2">ES6,</a> <a p="1">VanillaJS</a> has been on an equal footing with the original rock <a p="3">jQuery</a> in virtually all areas and is now far superior.');
        $this->assertSame(\__translate_microsoft('Sein oder Nichtsein; das ist hier die Frage.', 'de', 'en', 'WRONG_KEY!'), null);
    }
    function test__helpers()
    {
        $this->assertSame(\__x_all('foo', 'bar', null), \false);
        $this->assertSame(\__x_all(['foo', 'bar', null]), \false);
        $this->assertSame(\__x_all('foo', 'bar', 'baz'), \true);
        $this->assertSame(\__x_all(['foo', 'bar', 'baz']), \true);
        $this->assertSame(\__nx_all('foo', 'bar', null), \true);
        $this->assertSame(\__nx_all('foo', 'bar', 'baz'), \false);
        $this->assertSame(\__x_one('foo', 'bar'), \true);
        $this->assertSame(\__x_one('', null), \false);
        $this->assertSame(\__x_one(['foo', 'bar']), \true);
        $this->assertSame(\__x_one(['', null]), \false);
        $this->assertSame(\__nx_one('foo', 'bar'), \false);
        $this->assertSame(\__nx_one('', null), \true);
        $this->assertSame(\__true_all(\true, \true, \true), \true);
        $this->assertSame(\__true_all([\true, \true, null]), \false);
        $this->assertSame(\__true_all(\true, '1'), \true);
        $this->assertSame(\__true_all([\true, \false]), \false);
        $this->assertSame(\__false_all('foo', 'bar', null), \false);
        $this->assertSame(\__false_all(\false), \true);
        $this->assertSame(\__true_one(\true, \true, \true), \true);
        $this->assertSame(\__true_one([\true, \true, null]), \true);
        $this->assertSame(\__true_one(\true, '1'), \true);
        $this->assertSame(\__true_one([\true, \false]), \true);
        $this->assertSame(\__false_one('foo', 'bar', null), \false);
        $this->assertSame(\__false_one(\false), \true);
        $this->assertSame(\__validate_url('https://vielhuber.de'), \true);
        $this->assertSame(\__validate_email('david@vielhuber.de'), \true);
        $this->assertSame(\__validate_date('2000-01-01'), \true);
        $this->assertSame(\__validate_date('01.01.2000'), \true);
        ...
        $this->assertSame(\__validate_date(new \DateTime('2000-01-01')), \true);
        $this->assertSame(\__validate_date(946713600), \true);
        $this->assertSame(\__validate_date(null), \false);
        $this->assertSame(\__validate_date(''), \false);
        $this->assertSame(\__validate_date(\true), \false);
        $this->assertSame(\__validate_date(\false), \false);
        $this->assertSame(\__validate_date_format('d.m.Y'), \true);
        $this->assertSame(\__validate_date_format('Y-m-d'), \true);
        $this->assertSame(\__validate_date_format('Y/m/d'), \true);
        $this->assertSame(\__validate_date_format('01.m.Y'), \true);
        ...
        $this->assertSame(\__validate_date_format(\true), \false);
        $this->assertSame(\__validate_date_format(\false), \false);
        $this->assertSame(\__validate_date_format(''), \false);
        $this->assertSame(\__validate_date_mod('+6 months'), \true);
        $this->assertSame(\__validate_date_mod('+ 6 months'), \true);
        $this->assertSame(\__validate_date_mod('+1 week 2 days 4 hours 2 seconds'), \true);
        ...
        $this->assertSame(\__validate_date_mod(\true), \false);
        ...
        $this->assertSame(\in_array('49', \__phone_country_codes()), \true);
        $this->assertSame(\in_array('89', \__phone_area_codes()), \true);
        $this->assertSame(\in_array('151', \__phone_area_codes()), \true);
        $this->assertSame(\in_array('89', \__phone_area_codes_landline()), \true);
        $this->assertSame(\in_array('151', \__phone_area_codes_mobile()), \true);
        $this->assertSame(\__phone_is_landline('(0)89-12 456 666'), \true);
        $this->assertSame(\__phone_is_landline('141'), \false);
        $this->assertSame(\__phone_is_mobile('(0)89-12 456 666'), \false);
        $this->assertSame(\__phone_is_mobile('(0)151/58 75 46 91'), \true);
        ...
        $this->assertSame(\__url_normalize(\true), \true);
        ...
        $this->assertSame(\__minify_html(\true), \true);
        $this->assertSame(\__minify_html(\false), \false);
        $this->assertSame(\__minify_html(''), '');
        $this->assertSame(\__minify_html('<!DOCTYPE html>
<title>shortest valid html5 document</title>
<p>cool stuff</p>'), '<!DOCTYPE html><title>shortest valid html5 document</title> <p>cool stuff</p>');
        $this->assertSame(\__minify_html('<!doctype html>
<html lang="en">
<head>
...
<script>
...
</html>'), '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><link href="http://example.com/style.css" rel="stylesheet"><link rel="icon" href="http://example.com/favicon.png"><title>Tiny Html Minifier</title></head> <body class="body"><div class="main-wrap"> <main> <textarea>
            Some text
            with newlines
            and some spaces
    ...
    console.log("This is inside a script tag");
        ...
        $this->assertSame(\__remove_emoji(\true), \true);
        ...
        $this->assertSame(\__datetime(\true), null);
        ...
        $this->assertSame(\__date_reset_time(\true), null);
        ...
        $this->assertSame(\__age_from_date(\date(\strtotime('now - 20 years - 1 month')), \date(\strtotime('now - 10 years'))), 10);
        ...
        $this->assertSame(\__first_char_is_uppercase(\true), \false);
        ...
        $this->assertSame(\__first_char_is_uppercase('Foo'), \true);
        $this->assertSame(\__set_first_char_uppercase(\true), \true);
        ...
        $this->assertSame(\__shuffle_assoc(\true), null);
        $this->assertSame(\__shuffle_assoc(1337), null);
        $this->assertSame(\__shuffle_assoc([]), []);
        $this->assertSame(\__shuffle_assoc(['foo']), ['foo']);
        $this->assertSame(\__shuffle_assoc(['foo']), ['foo']);
        $this->assertSame(\__shuffle_assoc(['foo' => 'bar', 'bar' => 'baz', 'baz' => 'foo'])['foo'] === 'bar', \true);
        $this->assertSame(\__shuffle_assoc(['foo' => 'bar', 'bar' => 'baz', 'baz' => 'foo'])['bar'] === 'baz', \true);
        $this->assertSame(\__shuffle_assoc(['foo' => 'bar', 'bar' => 'baz', 'baz' => 'foo'])['baz'] === 'foo', \true);
        $arr = [['a' => 17, 'b' => 42], ['a' => 13, 'b' => 19]];
        \usort($arr, \__array_multisort([['a', 'asc'], ['b', 'asc']]));
        $this->assertSame($arr, [['a' => 13, 'b' => 19], ['a' => 17, 'b' => 42]]);
        \usort($arr, \__array_multisort(function ($v) {
            return [[$v['a'], 'asc'], [$v['b'], 'asc']];
        }));
        $this->assertSame($arr, [['a' => 13, 'b' => 19], ['a' => 17, 'b' => 42]]);
        $arr = [['a' => \true, 'b' => \true, 'c' => 'Test!'], ['a' => \true, 'b' => \false, 'c' => 'yo']];
        \usort($arr, \__array_multisort([['a', 'asc'], ['b', 'asc'], ['c', 'asc']]));
        $this->assertSame($arr, [['a' => \true, 'b' => \false, 'c' => 'yo'], ['a' => \true, 'b' => \true, 'c' => 'Test!']]);
        \usort($arr, \__array_multisort([['a', 'desc'], ['b', 'desc'], ['c', 'asc']]));
        $this->assertSame($arr, [['a' => \true, 'b' => \true, 'c' => 'Test!'], ['a' => \true, 'b' => \false, 'c' => 'yo']]);
        \usort($arr, \__array_multisort([['a', 'desc'], ['b', 'asc'], ['c', 'desc']]));
        $this->assertSame($arr, [['a' => \true, 'b' => \false, 'c' => 'yo'], ['a' => \true, 'b' => \true, 'c' => 'Test!']]);
        $arr = [['id' => 1, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 2, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 3, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 4, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 5, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 6, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32']];
        \usort($arr, \__array_multisort([['pos', 'asc'], ['date', 'asc'], ['created_at', 'asc'], ['id', 'asc']]));
        $this->assertEquals($arr, [['id' => 1, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 2, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 3, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 4, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 5, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32'], ['id' => 6, 'pos' => null, 'date' => new \ScopedGtbabel\dateTime('2020-01-01'), 'created_at' => '2020-01-16 13:03:32']]);
        ...
        $this->assertSame(\__array_group_by($arr, function ($v) {
            return $v['a'];
        }), [17 => [$a, $c], 19 => [$b]]);
        $this->assertSame(\__array_group_by($arr, function ($v) {
            return $v['a'];
        ...
        $this->assertSame(\__array_unique([['foo' => 'bar'], ['bar' => 'baz'], ['foo' => 'bar']]), [['foo' => 'bar'], ['bar' => 'baz']]);
        $this->assertSame(\__array_unique(null), null);
        $this->assertSame(\__array_unique([]), []);
        $this->assertSame(\__array_unique(''), '');
        $this->assertSame(\__array_unique(0), 0);
        $this->assertSame(\__array_unique(\true), \true);
        $this->assertSame(\__array_unique(\false), \false);
        $this->assertSame(\__array_map_deep(['foo', 'bar' => ['baz', 'gnarr']], function ($a) {
            return $a . '!';
        }), ['foo!', 'bar' => ['baz!', 'gnarr!']]);
        $this->assertSame(\__array_map_deep(['foo', 'bar' => ['baz', ['1', '2']]], function ($a) {
            return $a . '!';
        }), ['foo!', 'bar' => ['baz!', ['1!', '2!']]]);
        $this->assertSame(\__array_map_deep(null, function ($a) {
            return $a . '!';
        }), '!');
        $this->assertSame(\__array_map_deep(\true, function ($a) {
            return !$a;
        }), \false);
        $this->assertSame(\__array_map_deep([[[[[[[[[[[[[[[[[[[[\true]]]]]]]]]]]]]]]]]]]], function ($a) {
            return !$a;
        }), [[[[[[[[[[[[[[[[[[[[\false]]]]]]]]]]]]]]]]]]]]);
        $this->assertSame(\__array_map_deep([[[[[[[[[[[[[[[[[[[[42 => 'no', 7 => 'ok']]]]]]]]]]]]]]]]]]]], function ($value, $key) {
            return $key === 42 ? $value : $value . '!';
        }), [[[[[[[[[[[[[[[[[[[[42 => 'no', 7 => 'ok!']]]]]]]]]]]]]]]]]]]]);
        $this->assertSame(\__array_map_deep(['foo' => ['bar' => 'baz'], 'bar' => ['baz' => 'gnarr'], 'gnarr' => ['foo' => 'gnaz']], function ($value, $key, $key_chain) {
            return \in_array('bar', $key_chain) ? $value . '!' : $value;
        }), ['foo' => ['bar' => 'baz!'], 'bar' => ['baz' => 'gnarr!'], 'gnarr' => ['foo' => 'gnaz']]);
        $output = [];
        \__array_map_deep([1 => [2 => [3 => [4 => [5 => 'ok1'], 6 => [7 => 'ok2']]]], 8 => 'ok3'], function ($value, $key, $key_chain) use(&$output) {
        ...
        $this->assertSame(\strlen(\__uuid()) === 36, \true);
        $this->assertSame(\substr_count(\__uuid(), '-') === 4, \true);
        $this->assertSame(\__pushId() === \__pushId(), \false);
        $this->assertSame(\strlen(\__pushId()) === 20, \true);
        $this->assertSame(\strlen(\__pushId()) === 20, \true);
        $this->assertSame(\strlen(\__pushId()) === 20, \true);
        ...
        $this->assertSame(\__split_whitespace(\true, 3), \true);
        ...
        $this->assertSame(\__trim_whitespace('      string including nasty whitespace chars  '), 'string including nasty whitespace chars');
...
'), 'string including nasty whitespace chars');
        ...
        $this->assertSame(\__atrim(\true), \true);
        $this->assertSame(\__atrim([]), []);
        $this->assertSame(\__atrim(['foo', 'bar', 'baz']), ['foo', 'bar', 'baz']);
        $this->assertSame(\__atrim(['foo
', 'bar', '
baz']), ['foo', 'bar', 'baz']);
        $this->assertSame(\__string_is_json('[]'), \true);
        $this->assertSame(\__string_is_json('{"foo":"bar"}'), \true);
        ...
        $this->assertSame(\__is_serialized('a:1:{s:3:"foo";s:3:"bar";}'), \true);
        ...
        $this->assertSame(\__is_serialized('b:0;'), \true);
        $this->assertSame(\__is_base64_encoded('dGhpcyBpcyBjb29sIHN0dWZm'), \true);
        ...
        $this->assertSame(\__first_key(\true), null);
        $this->assertSame(\__first_key(''), null);
        $this->assertSame(\__first_key(['foo']), 0);
        $this->assertSame(\in_array(\__rand(['foo', 'bar', 'baz']), ['foo', 'bar', 'baz']), \true);
        $this->assertSame(\__remove_first(['foo', 'bar', 'baz']), ['bar', 'baz']);
        $this->assertSame(\__remove_last(['foo', 'bar', 'baz']), ['foo', 'bar']);
        $this->assertSame(\__can_be_looped([1, 2]), \true);
        $this->assertSame(\__can_be_looped((object) [1, 2]), \true);
        ...
        $this->assertEquals($arr, [0 => 'gnarr', 1 => 'foo', 2 => 'bar', 3 => 'baz']);
        $this->assertEquals(\__arr_append(\__arr_append(\__arr_append([], 'foo'), 'bar', \false), 'baz'), [0 => 'foo', 1 => 'baz']);
        ...
        $this->assertSame(\__highlight('Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est lorem ipsum dolor sit amet.', 'lorem'), '<strong class="highlight">Lorem</strong> ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est <strong class="highlight">Lorem</strong> ipsum dolor sit amet. <strong class="highlight">Lorem</strong> ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est <strong class="highlight">lorem</strong> ipsum dolor sit amet.');
        $this->assertSame(\__highlight('abc def geh ijk lmn opq rst abc def geh ijk lmn opq rst', 'ijk', \true, 5), '... geh <strong class="highlight">ijk</strong> lmn ... geh <strong class="highlight">ijk</strong> lmn ...');
        $this->assertSame(\__highlight('Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est lorem ipsum dolor sit amet.', 'elitr', \true, 20), '... sadipscing <strong class="highlight">elitr</strong>, sed diam nonumy eirmod ... sadipscing <strong class="highlight">elitr</strong>, sed diam nonumy eirmod ...');
        $this->assertSame(\__is_integer(0), \true);
        $this->assertSame(\__is_integer(42), \true);
        $this->assertSame(\__is_integer(4.2), \false);
        $this->assertSame(\__is_integer(0.42), \false);
        $this->assertSame(\__is_integer(42.0), \true);
        $this->assertSame(\__is_integer('42'), \true);
        $this->assertSame(\__is_integer('a42'), \false);
        $this->assertSame(\__is_integer('42a'), \false);
        $this->assertSame(\__is_integer(0x24), \true);
        $this->assertSame(\__is_integer(8.372468764378628E+30), \true);
        $this->assertSame(\__is_integer('8372468764378627868742367883268'), \true);
        ...
        $this->assertSame(\__is_integer(\true), \false);
        ...
        $this->assertSame(\__inside_out_values(['field1' => [0 => 'foo', 1 => 'bar', 2 => 'baz', 3 => ''], 'field2' => [0 => 'bar', 1 => 'baz', 2 => 'foo', 3 => null]]), [0 => ['field1' => 'foo', 'field2' => 'bar'], 1 => ['field1' => 'bar', 'field2' => 'baz'], 2 => ['field1' => 'baz', 'field2' => 'foo']]);
        $this->assertEquals(\__arrays_to_objects(['foo' => ['bar', 'baz'], 'bar' => [(object) ['id' => 7, 'name' => 'foo'], (object) ['id' => 42, 'name' => 'bar']]]), (object) ['foo' => (object) [0 => 'bar', 1 => 'baz'], 'bar' => (object) [7 => (object) ['id' => 7, 'name' => 'foo'], 42 => (object) ['id' => 42, 'name' => 'bar']]]);
        ...
        $this->assertSame(!empty($response->headers), \true);
        ...
        $response = \__curl('https://httpbin.org/basic-auth/foo/bar', null, null, null, \false, \true, 60, ['foo' => 'bar']);
        $this->assertSame($response->status, 200);
        $response = \__curl('https://httpbin.org/cookies', null, null, null, \false, \false, 60, null, null);
        $this->assertSame(empty((array) $response->result->cookies), \true);
        $response = \__curl('https://httpbin.org/cookies', null, null, null, \false, \false, 60, null, ['foo' => 'bar', 'bar' => 'baz']);
        $this->assertEquals($response->result->cookies, (object) ['foo' => 'bar', 'bar' => 'baz']);
        $response = \__curl('https://httpbin.org/absolute-redirect/1', null, null, null, \false, \false, 60, null, null, \true);
        $this->assertSame($response->status, 200);
        $response = \__curl('https://httpbin.org/absolute-redirect/1', null, null, null, \false, \false, 60, null, null, \false);
        ...
        if (1 == 0) {
            ...
            \__curl($wp_url . '/wp-login.php', ['log' => $wp_username, 'pwd' => $wp_password], 'POST', null, \true, \false);
            $response = \__curl($wp_url . '/wp-admin/options.php', null, 'GET', null, \true);
            // gets the html code of wp backend
        ...
        $this->assertEquals(\__success(), (object) ['success' => \true, 'message' => '']);
        $this->assertEquals(\__success('foo'), (object) ['success' => \true, 'message' => 'foo']);
        $this->assertEquals(\__error(), (object) ['success' => \false, 'message' => '']);
        $this->assertEquals(\__error('bar'), (object) ['success' => \false, 'message' => 'bar']);
        $this->assertSame(\in_array(\__os(), ['windows', 'mac', 'linux', 'unknown']), \true);
        $this->assertSame(\__url(), 'https://github.com/vielhuber/stringhelper');
        $this->assertSame(\__baseurl(), 'https://github.com');
        \define('ScopedGtbabel\\ENCRYPTION_KEY', '4736d52f85bdb63e46bf7d6d41bbd551af36e1bfb7c68164bf81e2400d291319');
        ...
        $this->assertSame(\__decrypt_poor($token, \true), 'bar');
        $this->assertSame(\__decrypt_poor($token, \true), null);
        \define('ScopedGtbabel\\ENCRYPTION_FOLDER', __DIR__ . '/');
        $token = \__encrypt_poor('bar');
        $this->assertSame(\__decrypt_poor($token, \true), 'bar');
        $this->assertSame(\__decrypt_poor($token, \true), null);
        $this->assertSame(\count(\__files_in_folder()) >= 6, \true);
        $this->assertSame(\count(\__files_in_folder('.')) >= 6, \true);
        $this->assertSame(\count(\__files_in_folder('.', \false, ['.gitignore'])) >= 5, \true);
        $this->assertSame(\in_array('.gitignore', \__files_in_folder('.', \false)), \true);
        $this->assertSame(\in_array('.gitignore', \__files_in_folder('.', \false, ['.gitignore'])), \false);
        $this->assertSame(\count(\__files_in_folder('tests')) === 2, \true);
        $this->assertSame(\count(\__files_in_folder('tests', \false, ['Test.php'])) === 1, \true);
        $this->assertSame(\count(\__files_in_folder('tests', \true)) > 2, \true);
        $this->assertSame(\count(\__files_in_folder('tests', \true, ['assets'])) === 2, \true);
        $this->assertSame(\count(\__files_in_folder('tests/', \true)) > 2, \true);
        $this->assertSame(\count(\__files_in_folder('foo')) === 0, \true);
        \mkdir('tests/foo');
        $this->assertSame(\count(\__files_in_folder('tests/foo')) === 0, \true);
        \touch('tests/foo/index.txt');
        $this->assertSame(\count(\__files_in_folder('tests/foo')) === 1, \true);
        $this->assertSame(\is_dir('tests/foo'), \true);
        \__rrmdir('tests/foo');
        $this->assertSame(!\is_dir('tests/foo'), \true);
        ...
        $this->assertSame(\__is_external('https://github.com/vielhuber/stringhelper/test.pdf'), \true);
        $this->assertSame(\__is_external('tel:+4989215400142'), \false);
        $this->assertSame(\__is_external('mailto:david@vielhuber.de'), \false);
        $this->assertSame(\__is_external('https://vielhuber.de'), \true);
        $this->assertSame(\__is_external('https://vielhuber.de/test.pdf'), \true);
        ...
        $this->assertSame($filesize1 > $filesize2, \true);
...
bar', 'windows'));
        ...
        $this->assertSame(\__line_endings_weak_equals(\file_get_contents('tests/assets/file1.txt'), \file_get_contents('tests/assets/file2.txt')), \true);
        $this->assertSame(\__line_endings_weak_equals(\file_get_contents('tests/assets/file1.txt'), \file_get_contents('tests/assets/file3.txt')), \true);
        $this->assertSame(\__line_endings_weak_equals(\file_get_contents('tests/assets/file2.txt'), \file_get_contents('tests/assets/file3.txt')), \true);
...
cool; stuff;');
        ...
        $this->assertSame(\__line_endings_weak_equals(\trim(\file_get_contents('tests/assets/file.txt')), 'baz
baz
baz
baz
baz
...
foo'), \true);
        ...
        $this->assertSame(\__line_endings_weak_equals(\trim(\file_get_contents('tests/assets/file.txt')), 'baz gnarr; /\\yoo&
foo
bar fuu; yoo//'), \true);
        @\unlink('tests/assets/file.txt');
        \__array2csv([['foo', 'bar', 'baz'], ['foo', 'bar', 'baz']], 'tests/assets/file.csv');
        $this->assertSame(\__line_endings_weak_equals(\trim(\file_get_contents('tests/assets/file.csv')), 'foo;bar;baz
foo;bar;baz'), \true);
        \__array2csv([['foo', 'bar', 'baz'], ['foo', 'bar', 'baz']], 'tests/assets/file.csv', ';', '"');
        $this->assertSame(\__line_endings_weak_equals(\trim(\file_get_contents('tests/assets/file.csv')), 'foo;bar;baz
foo;bar;baz'), \true);
        \__array2csv([['foo bar', 'bar', 'baz'], ['foo', 'bar', 'baz']], 'tests/assets/file.csv', ',', '\'');
        $this->assertSame(\__line_endings_weak_equals(\trim(\file_get_contents('tests/assets/file.csv')), '\'foo bar\',bar,baz
foo,bar,baz'), \true);
        \__array2csv([['foo', 'bar', 'baz'], ['foo', 'bar', 'baz']], 'tests/assets/file.csv');
    ...
    {
        $arr = [0 => 'foo', 1 => 'bar', 2 => 'baz'];
        $this->assertSame(\ScopedGtbabel\vielhuber\stringhelper\__::arr_append($arr, 'gnarr', 42 % 7 === 0), \__arr_append($arr, 'gnarr', 42 % 7 === 0));
    }
}
class Person
{
    ...
    {
        if ($id === 1 || $id === 2) {
            return new \ScopedGtbabel\Person($id);
        } else {
            return \__empty();
        }
    }
    ...
    {
        if ($this->id === 1) {
            return new \ScopedGtbabel\Address();
        } else {
            return \__empty();
        }
    }
...
class Address
{
    function getCountry()
    {
        return new \ScopedGtbabel\Country();
    }
}
class Country
{
