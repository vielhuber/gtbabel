...
<?php 
$items = ['null' => null, 'false' => \false, 'true' => \true, '[]' => [], '[\'\']' => [''], '0' => 0, '1' => 1, '-1' => -1, '\'0\'' => '0', '\'1\'' => '1', '\'-1\'' => '-1', '\'\'' => '', '\' \'' => ' ', '\'null\'' => 'null', '\'false\'' => 'false', '\'true\'' => 'true', '\'str\'' => 'str', '[0,1]' => [0, 1], '[0]' => [0], 'a:0:{}' => 'a:0:{}', 'b:1;' => 'b:1;', 'b:0;' => 'b:0;', 'new stdClass' => new \stdClass(), '$_GET[\'undefined\']' => 'error', '@$_GET[\'undefined\']' => @$_GET['undefined']];
echo '<textarea>';
...
foreach ($items as $items__key => $items__value) {
    ...
    \ScopedGtbabel\outputRow($items__value);
}
echo '</textarea>';
echo '<textarea>';
echo '| <sub>==</sub> ';
